...
ALTER TABLE challenges ADD COLUMN rewards_earned_ore BIGINT UNSIGNED DEFAULT 0 NOT NULL AFTER rewards_earned_coal;

ALTER TABLE rewards RENAME COLUMN balance TO balance_coal;
ALTER TABLE rewards ADD COLUMN balance_ore BIGINT UNSIGNED DEFAULT + NOT NULL AFTER balance_coal;