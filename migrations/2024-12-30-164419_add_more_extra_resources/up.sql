...
ALTER TABLE earnings_extra_resources ADD COLUMN generation_type INT DEFAULT 1 NOT NULL AFTER updated_at;
...
ALTER TABLE extra_resources_generation ADD COLUMN generation_type INT DEFAULT 1 NOT NULL AFTER updated_at;
